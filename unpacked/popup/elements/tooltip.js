customElements.define('tooltip-icon', class Tooltip extends HTMLElement {
    constructor() {
        super();
    }
    ...
    connectedCallback() {
        ...
        if (this.hasAttribute('size'))
            this.setAttribute('data-cooltipz-size', this.getAttribute('size'));

        if (this.hasAttribute('position'))
            this.setAttribute('data-cooltipz-dir', this.getAttribute('position'));
